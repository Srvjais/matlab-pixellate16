...
global botC1 botC2 Red Green Black inImg
Gtmp=imcrop(inImg);
Rtmp=imcrop(inImg);
BLtmp=imcrop(inImg);
c=30;                                                 %colour limit approx constant
...
botcol1=imcrop(inImg);
botcol2=imcrop(inImg);
%for bot colour 1
...
clearvars Gtmp Rtmp BLtmp botcol1 botcol2 c;